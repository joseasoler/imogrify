...
if (CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 16)
		message(FATAL_ERROR "${CMAKE_PROJECT_NAME} requires AppleClang 16 or newer.")
	endif ()
	set(IMOGRIFY_CXX_COMPILER_APPLE_CLANG 1)
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 16)
		message(FATAL_ERROR "${CMAKE_PROJECT_NAME} requires Clang 16 or newer.")
	endif ()
	set(IMOGRIFY_CXX_COMPILER_CLANG 1)
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 11)
		message(FATAL_ERROR "${CMAKE_PROJECT_NAME} requires GCC 11 or newer.")
	endif ()
...
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.30)
		message(FATAL_ERROR "${CMAKE_PROJECT_NAME} requires MSVC 19.30 or newer.")
	endif ()
