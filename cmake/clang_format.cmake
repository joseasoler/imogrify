...
if (IMOGRIFY_CLANG_FORMAT_BINARY)
	set(IMOGRIFY_CLANG_FORMAT_OPTIONS
		${IMOGRIFY_CLANG_FORMAT_BINARY}
		--dry-run
	)
	...
	file(GLOB_RECURSE IMOGRIFY_CLANG_FORMAT_FILES ${PROJECT_SOURCE_DIR}/imogrify/*.cpp ${PROJECT_SOURCE_DIR}/imogrify/*.hpp ${PROJECT_SOURCE_DIR}/tests/*.cpp ${PROJECT_SOURCE_DIR}/tests/*.hpp)
	...
	add_custom_command(OUTPUT ${IMOGRIFY_CLANG_FORMAT_TIMESTAMP_FILE}
	...
	# Use this target as a dependency to enforce clang-format to run on each compilation.
