...
if (IMOGRIFY_CLANG_FORMAT)
	...
	if(IMOGRIFY_CLANG_FORMAT_BINARY)
		...
		if(IMOGRIFY_CMAKE_VERBOSE)
			message(STATUS "Found ${IMOGRIFY_CLANG_FORMAT_BINARY}.")
		endif()
	elseif(IMOGRIFY_CMAKE_VERBOSE)
		message(STATUS "Could not find clang-format binary.")
	endif()
endif()
